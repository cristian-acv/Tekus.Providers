        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProvidersServices_Providers_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "Providers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProvidersServices_Services_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProvidersServices_ProviderId",
                table: "ProvidersServices",
                column: "ProviderId");

            migrationBuilder.CreateIndex(
                name: "IX_ProvidersServices_ServiceId",
                table: "ProvidersServices",
                column: "ServiceId");
        }
